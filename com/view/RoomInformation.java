    ...
    public RoomInformation(PagodaApp application) {
        super(application, "Room Information", new Option[]{
                new Option("See Room Information", (obj) -> {
                    ...
                    new HotelSeeRoomInformation(application).display(room, ((HashMap<String, String>) application.getSession().get("currentUser")).get("hotelID"));
                    application.clrscr();
                ...
                new Option("Edit Room Information", (obj) -> {
                    application.clrscr();
                    RoomManager room = new RoomManager(application.getConnection());
                    new EditRoomInformation(application).display(room,((HashMap<String, String>) application.getSession().get("currentUser")).get("hotelID"));
                    application.clrscr();
                    RoomInformation roomInformation = new RoomInformation(application);
                    roomInformation.display();
                ...
                new Option("Delete Room", (obj) -> {
                    application.clrscr();
                    RoomManager room = new RoomManager(application.getConnection());
                    new DeleteRoom(application).display(room,((HashMap<String, String>) application.getSession().get("currentUser")).get("hotelID"));
                    application.clrscr();
                    RoomInformation roomInformation = new RoomInformation(application);
                    roomInformation.display();
                    roomInformation.forwardUser(PAGODA_MENU_DEFAULT_INPUT_MESSAGE);
