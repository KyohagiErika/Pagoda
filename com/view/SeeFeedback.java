        ...
        try {
            ...
            if (feedbackList.size() == 0) {
                ...
                for (int i = 0; i < feedbackList.size();i++) {
                    System.out.printf("| %10d | %20s | %20s | %20s | %20s | %20s |\n",i+1, feedbackList.get(i).get("hotelId"),feedbackList.get(i).get("name"),feedbackList.get(i).get("evaluationDay"),feedbackList.get(i).get("vote"),feedbackList.get(i).get("feedback"));
                }
            }
