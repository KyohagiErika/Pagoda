        ...
        try {
            ...
            for(HashMap<String, String> item : viewCustomers) {
                ...
                System.out.printf("%10s | %20s | %20s | %20s | %20d | %15s | %15s | %15s | %20s | %15s",item.get("roomID"),
                        item.get("bookDay"),item.get("checkIn"),item.get("checkOut"),duration.toHours()*bookRoom.seePricePerNightOfRoom(currentUser.get("hotelID"),item.get("roomID"))/24,item.get("lastName"),
