        ...
        try {
            ...
            for(HashMap<String, String> item : viewCustomers) {
                ...
                System.out.printf("%10s | %20s | %20s | %20s | %20d | %15s | %15s | %15s | %20s | %15s",item.get("roomID"),
                        item.get("bookDay"),DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss").format(LocalDateTime.parse(item.get("checkIn"), DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))),
